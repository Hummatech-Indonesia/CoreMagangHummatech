...
Route::prefix('siswa-offline')->name(RolesEnum::OFFLINE->value . ".")->middleware(["roles:siswa-offline", 'auth'])->group(function () {
    ...
    Route::put('revision/{projectRevision}/update', [\App\Http\Controllers\ProjectController::class, 'updateRevision'])->name('project.revision.updateRevision');
...
Route::prefix('siswa-online')->name(RolesEnum::ONLINE->value)->middleware(['roles:siswa-online', 'auth'])->group(function () {
    # Home
