        ...
        <div class="col-lg-8 px-4">
            ...
            <div class="d-flex gap-5">
                ...
                <div class="gap-2 d-flex">
                    ...
                    <p class="text-muted">{{ $countSub }} Materi</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="home2" role="tabpanel">
            <div class="d-flex justify-content-between mb-3">
                ...
                <button type="button" class="btn mb-1 btn-sm btn-primary btn-lg px-4 fs-4 font-medium"
                    ...
                    <div class="col-12">
                        <div class="card border-start border-info py-3 px-4">
                            <div class="d-flex no-block align-items-center">
                                ...
                                <div class="ms-auto">
                                    <a href="/detail/pelajari/{{ $subCourse->id }}" class="btn btn-light-primary text-primary">
                                        Pelajari
