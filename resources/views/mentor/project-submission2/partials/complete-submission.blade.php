<div class="tab-pane {{ request()->has('complete_page') ? 'active' : '' }}" id="complete-project" role="tabpanel">
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-3 g-4">
        @forelse ($complete_projects as $project)
            <div class="col">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <span class="{{ $project->getProjectStatus()->color() }}  px-2 py-1 rounded-2">
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <a class="btn btn-primary w-100"
                                href="{{ route('mentor.project-submissions.show', $project->id) }}">Detail</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    {{ $complete_projects->appends(['complete_page' => request('complete_page')])->links() }}
</div>
