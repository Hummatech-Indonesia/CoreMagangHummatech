...
<div class="th-hero-wrapper hero-1" id="hero">
    ...
    <div class="container">
        <div class="hero-style1"><span class="hero-subtitle">Solution For Your Business</span>
            <h1 class="hero-title">Providing Technology</h1>
            <h1 class="hero-title">For Smart <span class="text-theme fw-medium">IT Solution</span></h1>
            <p class="hero-text">Rapidiously streamline revolutionary networks with technically sound deliverables.
                Authoritatively integrate installed base web-readiness. Quickly maximize superior process.</p>
            <div class="btn-group"><a href="about.html" class="th-btn">ABOUT US<i
                        class="fa-regular fa-arrow-right ms-2"></i></a>
                <div class="call-btn"><a href="https://www.youtube.com/watch?v=_sI_Ps7JSEk"
                        class="play-btn popup-video"><i class="fas fa-play"></i></a>
                    <div class="media-body"><a href="https://www.youtube.com/watch?v=_sI_Ps7JSEk"
                            class="btn-title popup-video">Watch Our Story</a> <span class="btn-text">Subscribe
                            Now</span></div>
                </div>
            </div>
        </div>
        ...
        <div class="row gy-4 justify-content-center">
            <div class="col-xl-4 col-md-6">
                <div class="feature-card">
                    <div class="shape-icon"><img src="assets_landing/img/icon/feature_card_1.png" alt="icon"></div>
                    <h3 class="box-title">Data Management Service</h3>
                    <p class="feature-card_text">Intrinsicly maximize best-of-breed strategic theme areas whereas
                        premium alignments. Collaboratively transition client.</p>
                </div>
            </div>
            <div class="col-xl-4 col-md-6">
                <div class="feature-card">
                    <div class="shape-icon"><img src="assets_landing/img/icon/feature_card_2.png" alt="icon"></div>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="feature-card">
                    <div class="shape-icon"><img src="assets_landing/img/icon/feature_card_3.png" alt="icon"></div>
            ...
            <div class="col-lg-7 text-lg-start text-center">
                <div class="ps-xxl-5">
                    ...
                    <div class="checklist style4 mb-40 list-center">
                        <ul>
                            <li><img src="assets_landing/img/icon/check_1.png" alt="icon"> Dramatically re-engineer value
                                added IT systems via mission</li>
                            <li><img src="assets_landing/img/icon/check_1.png" alt="icon"> Website & Mobile application
                                design & Development</li>
                            <li><img src="assets_landing/img/icon/check_1.png" alt="icon"> Professional User Experince &
                ...
                <div class="col-6 col-lg-auto">
                    <div class="counter-card">
                        ...
                        <div class="media-body">
                            ...
                            <p class="counter-card_text text-body">Skilled Experts</p>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-lg-auto">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="service-3d">
                                <div class="service-3d_icon"><img src="assets_landing/img/icon/service_3d_1.png" alt="Icon">
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="service-3d">
                                <div class="service-3d_icon"><img src="assets_landing/img/icon/service_3d_2.png" alt="Icon">
                                </div>
                                <div class="service-3d_content">
                        ...
                        <div class="swiper-slide">
                            <div class="service-3d">
                                <div class="service-3d_icon"><img src="assets_landing/img/icon/service_3d_3.png" alt="Icon">
                                </div>
                                <div class="service-3d_content">
                        ...
                        <div class="swiper-slide">
                            <div class="service-3d">
                                <div class="service-3d_icon"><img src="assets_landing/img/icon/service_3d_4.png" alt="Icon">
                                </div>
                                <div class="service-3d_content">
    ...
    <div class="container space">
        <div class="row align-items-center flex-row-reverse">
            <div class="col-lg-6 mb-30 mb-lg-0">
                <div class="img-box7">
                    <div class="img1"><img src="assets_landing/img/normal/why_3_1.png" alt="Why"></div>
                    <div class="shape1"><img src="assets_landing/img/normal/why_3_2.png" alt="About"></div>
                    <div class="shape2"><img src="assets_landing/img/normal/why_3_3.png" alt="About"></div>
                    <div class="color-animate"></div>
                </div>
            </div>
            <div class="col-lg-6 text-lg-start text-center">
                <div class="title-area mb-35"><span class="sub-title">WHY CHOOSE US</span>
                    <h2 class="sec-title">You Get IT & Business Solution</h2>
                </div>
                ...
                <div class="two-column mb-40 list-center">
                    <div class="checklist style2">
                        <ul>
                            <li><img src="assets_landing/img/icon/check_1.png" alt="icon"> Big Data Analysis</li>
                            <li><img src="assets_landing/img/icon/check_1.png" alt="icon"> 24/7 Online Support</li>
                        </ul>
                    </div>
                    <div class="checklist style2">
                        <ul>
                            <li><img src="assets_landing/img/icon/check_1.png" alt="icon"> High Quality Sicurity</li>
                            <li><img src="assets_landing/img/icon/check_1.png" alt="icon"> Virtual Support Team</li>
                        </ul>
                    </div>
                </div><a href="about.html" class="th-btn">LEARN MORE<i
                        class="fa-regular fa-arrow-right ms-2"></i></a>
            </div>
        </div>
    </div>
    ...
    <div class="round-container gr-bg4 space">
        <div class="container">
            <div class="row justify-content-lg-between justify-content-center align-items-center">
                <div class="col-lg-5 mb-n2 mb-lg-0">
                    <div class="title-area text-center text-lg-start"><span class="sub-title">CASE STUDY</span>
                        <h2 class="sec-title">Our Portfolio / Works</h2>
                    </div>
                </div>
                <div class="col-auto">
            ...
            <div class="slider-area">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="project-box">
                                <div class="project-img"><img src="assets_landing/img/project/project_3_1.jpg"
                                        alt="project image"></div>
                                <div class="project-content" data-bg-src="assets_landing/img/bg/project_card_bg.png">
                                    <div class="media-body">
                                        <h3 class="box-title"><a href="project-details.html">IT Consultency</a></h3>
                                        <p class="project-subtitle">Technology</p>
                                    </div><a href="assets_landing/img/project/project_3_1.jpg"
                        ...
                        <div class="swiper-slide">
                            <div class="project-box">
                                <div class="project-img"><img src="assets_landing/img/project/project_3_2.jpg"
                                        alt="project image"></div>
                                <div class="project-content" data-bg-src="assets_landing/img/bg/project_card_bg.png">
                                    <div class="media-body">
                                        <h3 class="box-title"><a href="project-details.html">Web Development</a>
                                        </h3>
                                        <p class="project-subtitle">Technology</p>
                                    </div><a href="assets_landing/img/project/project_3_2.jpg"
                                        class="icon-btn popup-image"><i class="far fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="project-box">
                                <div class="project-img"><img src="assets_landing/img/project/project_3_3.jpg"
                                        alt="project image"></div>
                                <div class="project-content" data-bg-src="assets_landing/img/bg/project_card_bg.png">
                                    <div class="media-body">
                                        <h3 class="box-title"><a href="project-details.html">Website Design</a></h3>
                                        <p class="project-subtitle">Technology</p>
                                    </div><a href="assets_landing/img/project/project_3_3.jpg"
                                        class="icon-btn popup-image"><i class="far fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="project-box">
                                <div class="project-img"><img src="assets_landing/img/project/project_3_4.jpg"
                                        alt="project image"></div>
                                <div class="project-content" data-bg-src="assets_landing/img/bg/project_card_bg.png">
                                    <div class="media-body">
                                        <h3 class="box-title"><a href="project-details.html">SEO Optimization</a>
                                        </h3>
                                        <p class="project-subtitle">Marketing</p>
                                    </div><a href="assets_landing/img/project/project_3_4.jpg"
                                        class="icon-btn popup-image"><i class="far fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                ...
                </div><button data-slider-prev="#projectSlider3" class="slider-arrow style3 slider-prev"><i
                        class="far fa-arrow-left"></i></button> <button data-slider-next="#projectSlider3"
                    class="slider-arrow style3 slider-next"><i class="far fa-arrow-right"></i></button>
            </div>
        </div>
        <div class="shape-mockup" data-top="0%" data-right="0%"><img src="assets_landing/img/shape/tech_shape_6.png"
                alt="shape"></div>
        <div class="shape-mockup" data-bottom="0%" data-left="0%"><img src="assets_landing/img/shape/tech_shape_7.png"
                alt="shape"></div>
    </div>
</section>
<section class="space" id="process-sec">
    <div class="container">
        <div class="title-area text-center"><span class="sub-title">WORK PROCESS</span>
            <h2 class="sec-title">How to work <span class="text-theme">it!</span></h2>
        </div>
        <div class="process-card-area">
            <div class="process-line position-top"><img src="assets_landing/img/bg/process_line_2.svg" alt="line"></div>
            <div class="row gy-40 justify-content-between">
                <div class="col-sm-6 col-xl-auto process-card-wrap">
                    <div class="process-card">
                        <div class="pulse"></div>
                        <div class="process-card_icon"><img src="assets_landing/img/icon/process_box_1.png" alt="icon">
                        </div>
                ...
                <div class="col-sm-6 col-xl-auto process-card-wrap">
                    <div class="process-card">
                        <div class="pulse"></div>
                        <div class="process-card_icon"><img src="assets_landing/img/icon/process_box_2.png" alt="icon">
                        </div>
                ...
                <div class="col-sm-6 col-xl-auto process-card-wrap">
                    <div class="process-card">
                        <div class="pulse"></div>
                        <div class="process-card_icon"><img src="assets_landing/img/icon/process_box_3.png" alt="icon">
                        </div>
                ...
                <div class="col-sm-6 col-xl-auto process-card-wrap">
                    <div class="process-card">
                        <div class="pulse"></div>
                        <div class="process-card_icon"><img src="assets_landing/img/icon/process_box_4.png" alt="icon">
                        </div>
...
<section class="">
    <div class="round-container" data-bg-src="assets_landing/img/bg/testi_bg_4.jpg">
        <div class="container">
            <div class="testi-block-area">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="testi-block">
                                <p class="testi-block_text">“Completely drive innovative value whereas
                                    out-of-the-box paradigms. Interactively pursue stand-alone markets after global
                                    results. Globally plagiarize intermandated opportunities with. Progressively
                                    leverage others multifunctional methods.”</p>
                                <div class="testi-block_profile">
                                    <div class="testi-block_avater"><img src="assets_landing/img/testimonial/testi_4_1.jpg"
                                            alt="Avater"></div>
                                    <div class="media-body">
                                        <h3 class="box-title">Md Sumon Mia</h3>
                                        <p class="testi-block_desig">CEO at Rimasu</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="testi-block">
                                <p class="testi-block_text">“Completely drive innovative value whereas
                                    ...
                                    leverage others multifunctional methods.”</p>
                                <div class="testi-block_profile">
                                    <div class="testi-block_avater"><img src="assets_landing/img/testimonial/testi_4_2.jpg"
                                            alt="Avater"></div>
                                    <div class="media-body">
                                        <h3 class="box-title">David Farnandes</h3>
                                        <p class="testi-block_desig">CEO at Anaton</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="testi-block">
                                <p class="testi-block_text">“Completely drive innovative value whereas
                                    ...
                                    leverage others multifunctional methods.”</p>
                                <div class="testi-block_profile">
                                    <div class="testi-block_avater"><img src="assets_landing/img/testimonial/testi_4_3.jpg"
                                            alt="Avater"></div>
                                    <div class="media-body">
                                        <h3 class="box-title">Abraham Khalil</h3>
                                        <p class="testi-block_desig">CEO at Kormola</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="testi-block">
                                <p class="testi-block_text">“Completely drive innovative value whereas
                                    ...
                                    leverage others multifunctional methods.”</p>
                                <div class="testi-block_profile">
                                    <div class="testi-block_avater"><img src="assets_landing/img/testimonial/testi_4_4.jpg"
                                            alt="Avater"></div>
                                    <div class="media-body">
                                        <h3 class="box-title">Jackline Techie</h3>
                                        <p class="testi-block_desig">CEO at Anatora</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="testi-block-quote"><img src="assets_landing/img/icon/quote_3d.png" alt="quote"></div>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container space-bottom">
        <div class="slider-area text-center">
            <div class="swiper th-slider"
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="brand-box"><img src="assets_landing/img/brand/brand_1_1.png" alt="Brand Logo"></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="brand-box"><img src="assets_landing/img/brand/brand_1_2.png" alt="Brand Logo"></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="brand-box"><img src="assets_landing/img/brand/brand_1_3.png" alt="Brand Logo"></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="brand-box"><img src="assets_landing/img/brand/brand_1_4.png" alt="Brand Logo"></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="brand-box"><img src="assets_landing/img/brand/brand_1_5.png" alt="Brand Logo"></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="brand-box"><img src="assets_landing/img/brand/brand_1_6.png" alt="Brand Logo"></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="brand-box"><img src="assets_landing/img/brand/brand_1_1.png" alt="Brand Logo"></div>
                    </div>
    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-xl-6 mt-35 mt-xl-0">
                <div class="img-box8">
                    <div class="img1"><img src="assets_landing/img/normal/faq_2_1.png" alt="Faq"></div>
                    <div class="shape1"><img src="assets_landing/img/normal/faq_2_2.png" alt="About"></div>
                    <div class="shape2"><img src="assets_landing/img/normal/faq_2_3.png" alt="About"></div>
                    <div class="color-animate"></div>
                </div>
            </div>
        </div>
...
<section class="space" id="blog-sec">
    <div class="container">
        <div class="title-area text-center"><span class="sub-title">NEWS & ARTICLES</span>
            <h2 class="sec-title">Get Every Single Update Blog</h2>
        </div>
        <div class="slider-area">
            <div class="swiper th-slider has-shadow" id="blogSlider4"
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="blog-card">
                            <div class="blog-img"><img src="assets_landing/img/blog/blog_1_5.jpg" alt="blog image"></div>
                            <div class="blog-content">
                                ...
                                <div class="blog-bottom"><a href="blog.html" class="author"><img
                                            src="assets_landing/img/blog/author-1-1.png" alt="avater"> By Themeholy</a> <a
                    ...
                    <div class="swiper-slide">
                        <div class="blog-card">
                            <div class="blog-img"><img src="assets_landing/img/blog/blog_1_6.jpg" alt="blog image"></div>
                            <div class="blog-content">
                    ...
                    <div class="swiper-slide">
                        <div class="blog-card">
                            <div class="blog-img"><img src="assets_landing/img/blog/blog_1_7.jpg" alt="blog image"></div>
                            <div class="blog-content">
                    ...
                    <div class="swiper-slide">
                        <div class="blog-card">
                            <div class="blog-img"><img src="assets_landing/img/blog/blog_1_8.jpg" alt="blog image"></div>
                            <div class="blog-content">
            ...
            </div><button data-slider-prev="#blogSlider4" class="slider-arrow style3 slider-prev"><i
                    class="far fa-arrow-left"></i></button> <button data-slider-next="#blogSlider4"
                class="slider-arrow style3 slider-next"><i class="far fa-arrow-right"></i></button>
        </div>
    </div>
    <div class="shape-mockup" data-top="0%" data-right="0%"><img src="assets_landing/img/bg/blog_bg_4.png" alt="shape">
    </div>
</section>
@endsection
