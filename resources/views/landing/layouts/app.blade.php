...
<!-- Mirrored from html.themeholy.com/webteck/demo/home-software-company.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Mar 2024 09:29:33 GMT -->

<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Webteck - Technology & IT Solutions HTML Template - Software Company</title>
    ...
    <link rel="apple-touch-icon" sizes="60x60" href="assets_landing/img/favicons/apple-icon-60x60.png">
    <link rel="apple-touch-icon" sizes="72x72" href="assets_landing/img/favicons/apple-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="76x76" href="assets_landing/img/favicons/apple-icon-76x76.png">
    <link rel="apple-touch-icon" sizes="114x114" href="assets_landing/img/favicons/apple-icon-114x114.png">
    <link rel="apple-touch-icon" sizes="120x120" href="assets_landing/img/favicons/apple-icon-120x120.png">
    <link rel="apple-touch-icon" sizes="144x144" href="assets_landing/img/favicons/apple-icon-144x144.png">
    <link rel="apple-touch-icon" sizes="152x152" href="assets_landing/img/favicons/apple-icon-152x152.png">
    <link rel="apple-touch-icon" sizes="180x180" href="assets_landing/img/favicons/apple-icon-180x180.png">
    <link rel="icon" type="image/png" sizes="192x192" href="assets_landing/img/favicons/android-icon-192x192.png">
    <link rel="icon" type="image/png" sizes="32x32" href="assets_landing/img/favicons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="96x96" href="assets_landing/img/favicons/favicon-96x96.png">
    <link rel="icon" type="image/png" sizes="16x16" href="assets_landing/img/favicons/favicon-16x16.png">
    ...
    <link
        ...
        rel="stylesheet">
    <link rel="stylesheet" href="assets_landing/css/app.min.css">
    <link rel="stylesheet" href="assets_landing/css/fontawesome.min.css">
...
<body class="gradient-body">
                    ...
                    <ul class="woocommerce-mini-cart cart_list product_list_widget">
                        <li class="woocommerce-mini-cart-item mini_cart_item"><a href="#"
                                class="remove remove_from_cart_button"><i class="far fa-times"></i></a> <a href="#"><img
                                    src="assets_landing/img/product/product_thumb_1_1.jpg" alt="Cart Image">Gaming Computer</a>
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item"><a href="#"
                                class="remove remove_from_cart_button"><i class="far fa-times"></i></a> <a href="#"><img
                                    src="assets_landing/img/product/product_thumb_1_2.jpg" alt="Cart Image">Smartphone Vivo
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item"><a href="#"
                                class="remove remove_from_cart_button"><i class="far fa-times"></i></a> <a href="#"><img
                                    src="assets_landing/img/product/product_thumb_1_3.jpg" alt="Cart Image">SanDisk Flash
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item"><a href="#"
                                class="remove remove_from_cart_button"><i class="far fa-times"></i></a> <a href="#"><img
                                    src="assets_landing/img/product/product_thumb_1_4.jpg" alt="Cart Image">Smart Power Bank</a>
                            <span class="quantity">1 × <span class="woocommerce-Price-amount amount"><span
                                        class="woocommerce-Price-currencySymbol">$</span>723.00</span></span></li>
                        <li class="woocommerce-mini-cart-item mini_cart_item"><a href="#"
                                class="remove remove_from_cart_button"><i class="far fa-times"></i></a> <a href="#"><img
                                    src="assets_landing/img/product/product_thumb_1_5.jpg" alt="Cart Image">Apple Smartwatch</a>
                            <span class="quantity">1 × <span class="woocommerce-Price-amount amount"><span
    ...
    <div class="th-menu-wrapper">
        <div class="th-menu-area text-center"><button class="th-menu-toggle"><i class="fal fa-times"></i></button>
            <div class="mobile-logo"><a href="index.html"><img src="assets_landing/img/logo.svg" alt="Webteck"></a></div>
                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto">
                            <div class="header-logo"><a class="icon-masking" href="index.html"><span
                                        data-mask-src="assets_landing/img/logo.svg" class="mask-icon"></span><img
                                        src="assets_landing/img/logo.svg" alt="Webteck"></a></div>
                        </div>
                        <div class="col-auto">
    ...
    <footer class="footer-wrapper footer-layout2 bg-transparent">
                    ...
                    <div class="col-md-6 col-xxl-3 col-xl-4">
                        <div class="widget footer-widget">
                            <div class="th-widget-about">
                                <div class="about-logo"><a href="index.html"><img src="assets_landing/img/logo-small.svg"
                                            alt="Webteck"></a></div>
                            ...
                            <div class="recent-post-wrap">
                                <div class="recent-post">
                                    <div class="media-img"><a href="blog-details.html"><img
                                                src="assets_landing/img/blog/recent-post-2-1.jpg" alt="Blog Image"></a></div>
                                    <div class="media-body">
                                ...
                                <div class="recent-post">
                                    <div class="media-img"><a href="blog-details.html"><img
                                                src="assets_landing/img/blog/recent-post-2-2.jpg" alt="Blog Image"></a></div>
                                    <div class="media-body">
        ...
        <div class="shape-mockup" data-top="0%" data-left="0%"><img src="assets_landing/img/shape/footer_shape_3.png"
                alt="shape"></div>
        <div class="shape-mockup" data-top="0%" data-right="0%"><img src="assets_landing/img/shape/footer_shape_4.png"
                alt="shape"></div>
        <div class="shape-mockup" data-bottom="0%" data-left="0%"><img src="assets_landing/img/shape/footer_shape_5.png"
                alt="shape"></div>
        <div class="shape-mockup" data-bottom="0%" data-right="0%"><img src="assets_landing/img/shape/footer_shape_6.png"
                alt="shape"></div>
    </footer>
    ...
    <script src="assets_landing/js/vendor/jquery-3.7.1.min.js"></script>
    <script src="assets_landing/js/app.min.js"></script>
    <script src="assets_landing/js/main.js"></script>
</body>
<!-- Mirrored from html.themeholy.com/webteck/demo/home-software-company.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Mar 2024 09:29:49 GMT -->
