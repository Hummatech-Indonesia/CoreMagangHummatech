...
<head>
    ...
    <link rel="icon" type="image/png" sizes="192x192" href="{{ asset('mobilelogo.png') }}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('mobilelogo.png') }}">
    <link rel="icon" type="image/png" sizes="96x96" href="{{ asset('mobilelogo.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('mobilelogo.png') }}">
