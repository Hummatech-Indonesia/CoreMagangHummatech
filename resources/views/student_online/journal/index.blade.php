...
@section('content')
            ...
            <div class="modal-content">
                ...
                <form action="/create/jurnal" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <label for="deskripsi">Deskripsi <span style="font-size: .6875rem" class="text-danger">*Wajib
                                diisi</span></label>
                        <textarea name="description" class="description-hidden form-control" cols="10" rows="5">{!! old('description') !!}</textarea>
                        @error('description')
                            <p class="text-danger">
                                {{ $message }}
                            </p>
                        ...
                        <tr>
                            <td colspan="8" class="text-center">
                                <div class="col-md-12 text-center">
                                    ...
                                    <h3 class="text-center">Belum ada jurnal</h3>
                                </div>
                            </td>
                        </tr>
                        @endforelse
    ...
    <div class="modal fade modal-bookmark" id="detail" tabindex="-1" role="dialog"
