...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-4 col-sm-12 col-xl-3">
          <div class="card">
            <img class="card-img-top img-responsive w-100" src="{{ asset('assets/images/materi-1.png') }}" style="object-fit: cover; min-height:20px; min-width:100px" alt="Card image cap" />
            <div class="d-flex justify-content-between px-3" style="margin-top: -27px">
                <img src="{{ asset('berkas/logo.png') }}" class="rounded-circle rounded" width="50px">
                <div class="px-2 py-1 rounded-2 rounded" style="background: #fff; font-size: 12px;">{{ $course->division->name }}</div>
            </div>
            <div class="card-body">
                <a href="/siswa-online/materi/detail" style="font-size: 15px" class="text-dark">
                    {{ $course->title }}
                </a>
