...
@section('content')
    <div class="row g-2 mb-4">
        ...
        <div class="col-sm-auto ms-auto">
            <div class="text-end">
                <a href="/siswa-online/tugas" class="btn btn-primary">Kembali</a>
            </div>
        </div>
    </div>
    <div class="row">
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    <div class="bg-light-primary rounded-2 p-3">
                                                        ...
                                                        <p class="px-4 mb-0 pb-0">Pengumpulan Tugas Berupa Link Youtube Ataupun link yang lain sesuai arahan dari mentor</p>
                                                    </div>
                                                </div>
                                                <div class="mb-2">
                                                    <h6>
                                ...
                                <div class="ms-auto">
                                    ...
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a href="/siswa-online/tugas/detail/detail-jawaban" class="dropdown-item btn-show" data-id="1"
                                                ...
                                                <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M7.08333 8.5C7.08333 8.87572 7.23259 9.23606 7.49827 9.50173C7.76394 9.76741 8.12428 9.91667 8.5 9.91667C8.87572 9.91667 9.23606 9.76741 9.50173 9.50173C9.76741 9.23606 9.91667 8.87572 9.91667 8.5C9.91667 8.12428 9.76741 7.76394 9.50173 7.49827C9.23606 7.23259 8.87572 7.08333 8.5 7.08333C8.12428 7.08333 7.76394 7.23259 7.49827 7.49827C7.23259 7.76394 7.08333 8.12428 7.08333 8.5Z" stroke="#5A6A85" stroke-linecap="round" stroke-linejoin="round"/>
                                                    <path d="M14.875 8.5C13.175 11.3333 11.05 12.75 8.5 12.75C5.95 12.75 3.825 11.3333 2.125 8.5C3.825 5.66667 5.95 4.25 8.5 4.25C11.05 4.25 13.175 5.66667 14.875 8.5Z" stroke="#5A6A85" stroke-linecap="round" stroke-linejoin="round"/>
                                                </svg>    
                                                Lihat Detail
                                                </a>
                                            </li>
