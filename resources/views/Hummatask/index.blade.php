...
@endif
                        ...
                        <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
                            <div class="mx-3">
                                ...
                                <input type="text" name="project_name" class="form-control"
                                    placeholder="Masukkan Project" value="{{ old('project_name') }}">
                                @error('project_name')
                                ...
                                <select class="form-control" onchange="changeProject(this)" name="type_project">
                                ...
                                <input type="text" name="leader_id" class="form-control" placeholder="Leader"
    ...
    <div class="row row-cols-3 gx-3">
        @foreach ($presentations as $presentation)
                ...
                <div class="card">
                    <div class="card-header bg-transparent d-flex align-items-end gap-2 position-relative">
                        <div class="position-absolute d-flex gap-1" style="top:10px; right:20px">
                            ...
                            <button class="btn btn-danger" data-bs-toggle="modal"
                                data-bs-target="#delete-modal-{{ $presentation->id }}">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="d-flex gap-2 align-items-center">
                            <span class="fs-2 p-2 px-3 rounded-pill text-primary" style="background:rgba(93,135,255,.2)">
                                {{ $presentation->status_presentation }}
                            </span>
                            <span class="fs-2 p-2 px-3 rounded-pill " style="background:rgba(118, 118, 128, .2)">Direvisi
                                (5)</span>
                        </div>
                        <hr>
            ...
            <div class="modal fade" id="delete-modal-{{ $presentation->id }}" tabindex="-1"
