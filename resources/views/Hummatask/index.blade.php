                ...
                <div class="modal-body">
                    <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
                        <div class="mx-3">
                            ...
                            <select class="form-control" placeholder="Kategori Project"
                                value="{{ old('type_project') }}" onchange="changeProject(this)">
            ...
            {{-- <div class="col-sm-8">--}}
                {{-- <div class="d-flex align-items-center mb-7">--}}
                    {{-- <div class="rounded-circle overflow-hidden me-6">--}}
                        {{-- @if(auth()->user()->student->avatar != null &&
                        Storage::disk('public')->exists(auth()->user()->student->avatar))--}}
...
<div class="row row-cols-3 gx-3">
    @foreach($presentations as $presentation)
        <div class="col">
            <div class="card">
                <div class="card-header bg-transparent d-flex align-items-end gap-3 position-relative">
