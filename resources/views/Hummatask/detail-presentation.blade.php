...
@section('content')
                            ...
                            <div class="mx-3">
                                ...
                                <div id="memberSection">
                                    <label class="d-block mb-2 mt-4" for="">Anggota
                                        Tim</label>
                                    <select class="js-example-basic-multiple d-block w-100 text-gray-900"
                                            id="selectMembers"
    ...
    <div class="d-flex mb-4 justify-content-between gap-2 w-100">
        <a href="/dashboard/task" class="text-decoration-none">
            <div class="back bg-label-primary p-3 rounded">
        ...
        <div class="bg-label-primary text-center w-100 d-flex justify-content-center align-items-center">
            <h2 class="text-primary fw-bolder fs-4">{{ $presentation->project_name }}</h2>
        </div>
        <div class="presentation-action d-flex gap-2">
            <button class="px-3 btn" style="background: #FFF5E3" data-bs-toggle="modal" data-bs-target="#editModal"
                    type="button">
            ...
            <form class="ms-2 p-0" action="{{ route('presentations.destroy', $presentation->id) }}"
                ...
                @csrf
                @method('DELETE')
                <button class="px-3 btn" style="background: #FBF2EF">
