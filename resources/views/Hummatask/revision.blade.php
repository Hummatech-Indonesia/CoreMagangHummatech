                    ...
                    <div class="container">
                                ...
                                <div class="container rounded-1 bg-light-primary position-relative p-3">
                                    <div class="d-flex">
                                        <div class="mt-2 flex-grow-1">
                                            <p class="fw-semibold fs-1 mb-2 mt-2" style="color: #0da8ff">
                                                Super awesome, Vue coming s awesome, Vue coming s awesome, Vue coming s awesome, Vue coming sooawesome, Vue coming sooawesome, Vue coming sooawesome, Vue coming soo n!
                                            </p>
                                        </div>
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <ul class="hstack mb-2">
                                            ...
                                            <li class="ms-n8">
                                                <a href="javascript:void(0)" class="me-1" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="mustafa" data-bs-original-title="mustafa">
                                                    <img src="assets-user/dist/images/profile/user-4.jpg" class="rounded-circle border border-2 border-white" width="33" height="33" alt="">
                                                </a>
                                            </li>
                                            <li class="ms-n8">
                                                <a href="javascript:void(0)" class="me-1" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Mark Smith" data-bs-original-title="Mark Smith">
                                                    <img src="assets-user/dist/images/profile/user-5.jpg" class="rounded-circle border border-2 border-white" width="33" height="33" alt="">
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <div class="mb-4 mt-4">
                            <a href="" style="color: gray; display: flex; align-items: center;">
                                ...
                                <svg style="margin-left: 170px" data-bs-toggle="tooltip" data-bs-placement="bottom" aria-label="Tambahkan" data-bs-original-title="Tambahkan" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24"><path fill="currentColor" d="M20 2H8c-1.103 0-2 .897-2 2v12c0 1.103.897 2 2 2h12c1.103 0 2-.897 2-2V4c0-1.103-.897-2-2-2M8 16V4h12l.002 12z"/><path fill="currentColor" d="M4 8H2v12c0 1.103.897 2 2 2h12v-2H4zm11-2h-2v3h-3v2h3v3h2v-3h3V9h-3z"/></svg>
                            </a>
