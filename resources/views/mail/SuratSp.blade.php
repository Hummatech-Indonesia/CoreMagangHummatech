                ...
                <table role="presentation" cellpadding="0" cellspacing="0" style="font-size: 0px; width: 100%"
                    ...
                    <tbody>
                        <tr>
                            <td
                                style="
                  background-image:url(https://i.postimg.cc/tgD9pRzH/Whats-App-Image-2024-01-14-at-10-58-53-20959d4c.jpg);
                    text-align: center;
                    vertical-align: top;
                    direction: ltr;
                    font-size: 0px;
                    ...
                    ">
                            ...
                            "
                              ...
                              ">
                                  ...
                                  font-size: 20px;
                                  color: #090909;
                                  letter-spacing: 0.27px; font-weight: 600;
                                ">
                                                            Halo {{ $data['nama'] }},
                                                        </h2>
                                                        <p style="color: black; font-weight: 500;">
                                                            Anda Telah Dikenakan Sp {{ $data['sp'] }} Dikarenakan :
                                                        </p>
                                                        <p>
                                                            {{ $data['alasan'] }}
                                                        </p>
