...
<style>
    ...
    /* Optional: Ensure modal body is scrollable */
            ...
            <form action="/create/jurnal" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <textarea name="description" id="description" class="form-control" rows="3"
                        onkeyup="countCharacters(this)">{{ old('description') }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="monthSelect" name="month">
                            @foreach ($months as $month)
                                <option value="{{ $month['value'] }}" {{ $month['value'] == old('month', request('month')) ? 'selected' : '' }}>
                                    {{ $month['name'] }}
                                </option>
                            @endforeach
                        </select>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    ...
                                    <button type="button" class="bg-transparent border-0 btn-detail"
                                        ...
                                        data-date="{{ $journal->created_at }}" data-school="{{ $journal->student->school }}"
...
<!-- Modal -->
<div class="modal fade modal-bookmark" id="detail" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content px-2">
            ...
            <div class="modal-footer">
                <div class="d-flex justify-content-end">
                    <button class="purchase-btn btn btn-hover-effect btn-light-danger text-danger f-w-500" type="button"
                        data-bs-dismiss="modal">Tutup</button>
                </div>
            </div>
        </div>
