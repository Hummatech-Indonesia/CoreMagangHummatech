                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-wrap gap-2">
                                <p class="badge bg-{{ $challenge->level->color() }}-subtle text-{{ $challenge->level->color() }}" style="font-size: 12px">
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-wrap gap-2">
                                        <p class="badge bg-primary-subtle text-primary" style="font-size: 12px">
                                            Batas: {{ \Carbon\Carbon::parse($challengePending->deadline)->locale('id_ID')->isoFormat('dddd, D MMMM YYYY') }}
                                        </p>
                                        <p class="badge bg-{{ $challengePending->challenge->level->color() }}-subtle text-{{ $challengePending->challenge->level->color() }}" style="font-size: 12px">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex gap-2 flex-wrap">
                                    ...
                                    <p class="badge bg-{{ $challengeDone->challenge->level->color() }}-subtle text-{{ $challengeDone->challenge->level->color() }}" style="font-size: 12px">{{ $challengeDone->challenge->level->label() }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="modal-body">
                            <div class="mb-2">
                                <div class="gap-1 d-flex align-items-center">
                                    <svg width="26" class="me-1" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="bg-light-primary p-2 rounded-2">
                                        Kumpulkan jawaban kamu berupa fille zip
                                    </div>
                                </div>
      ...
      <div class="modal fade" id="modal-detail" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                <div class="modal-header d-flex align-items-center">
                    <h4 class="modal-title" id="myLargeModalLabel">
                        Edit Tantangan Yang Terselesaikan
                    </h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
