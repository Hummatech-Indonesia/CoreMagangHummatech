        ...
        <div class="col-md-4 col-xxl-3">
            <div class="card card-body p-3">
                ...
                <div class="d-flex flex-column flex-lg-row gap-2 w-100">
                    <a href="{{ route('student.course.show', $course->id) }}" class="btn w-100 btn-lg btn-outline-primary">Detail</a>
                    <a href="{{ route('transaction.checkout-course', $course->id) }}" class="btn btn-lg btn-primary w-100 btn-lg">Beli</a>
                </div>
            </div>
        </div>
    @endforeach
