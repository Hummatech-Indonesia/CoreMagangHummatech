...
@section('content')
                            ...
                            <div class="d-flex gap-3 align-items-center">
                                <div class="d-flex justify-content-center">
                                    <div class="image-cart-square"
                                        style="background-image: url({{ asset('assets-user/images/laravel-11.jpg') }})">
                                    </div>
                                </div>
                                <div class="">
    ...
    @endif -->
                    ...
                    <div class="p-3 border rounded mb-1">
                        <div class="fw-bolder mb-3 align-items-center pb-3 border-bottom d-flex justify-content-between">
                            <span>Subtotal:</span>
...
@section('script')
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" data-bs-toggle="choose-payment" class="btn btn-primary"
                        data-bs-dismiss="modal">Pilih Pembayarannya</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        $('[data-bs-toggle="choose-payment"]').on('click', () => {
            ...
            const tax = parseFloat($('#tax').data('value') ?? 0);
            ...
            $('#additional-fee').html(`
                <div class="fw-bolder pb-3 mb-3 border-bottom d-flex justify-content-between">
                    ...
                    <span id="subtotal-show" class="fw-bolder text-primary">0</span>
                </div>
            `);
