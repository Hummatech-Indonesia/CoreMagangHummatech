    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-8 mb-3 mb-lg-0">
                ...
                <div class="p-3 p-md-4 py-4 py-md-5 border rounded mt-3">
                    <div class="pb-4 d-flex px-3"><strong>Detail Tagihan</strong></div>
                    <div class="d-flex justify-content-between flex-column flex-xl-row px-3 pb-3 mb-3 border-bottom">
                    ...
                    <div class="d-flex justify-content-between flex-column flex-xl-row px-3 pb-3 mb-3 border-bottom bg-white">
                    ...
                    <div class="d-flex justify-content-between flex-column flex-xl-row px-3">
