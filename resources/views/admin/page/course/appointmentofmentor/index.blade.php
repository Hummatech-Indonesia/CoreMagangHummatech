    ...
    <div class="modal fade" id="add" tabindex="-1" aria-labelledby="varyingcontentModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="/administrator/appointmentofmentor/store" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group mb-3 mt-3 col-md-12">
                            <label for="course_id">Materi</label>
                            <select name="course_id" class="js-example-basic-single1 form-select">
                        ...
                        <div class="form-group mb-3 mt-3 col-md-12">
                            ...
                            <select name="mentor_id" class="js-example-basic-single1 form-select">
            ...
            <div class="modal-content">
                ...
                <form method="POST" enctype="multipart/form-data"  id="form-update">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-3 mt-3 col-md-12">
                            <label for="mentor_id">Mentor</label>
                            <select name="mentor_id" class="js-example-basic-single1 form-select name-edit" id="name-edit">
                                <option value="" disabled selected>Pilih Mentor</option>
                                @foreach ($mentors as $mentor)
                                    <option value="{{ $mentor->id }}">{{ $mentor->name }}</option>
                                @endforeach
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        @forelse ($appointmentOfAmentors as $appointmentOfAmentor)
                            <tr>
                                <td>
                                    {{ $appointmentOfAmentor->mentors->name }}
                                </td>
                                <td>
                                    {{ $appointmentOfAmentor->mentors->email }}
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="gap-2">
                                        <button class="bg-transparent border-0 btn-delete"
