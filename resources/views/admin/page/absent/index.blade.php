                    ...
                    <form action="{{ route('attendance.offline.store') }}" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="mb-4">
                                ...
                                <select
                                    class="tambah js-example-basic-single form-control @error('name') is-invalid @enderror"
    ...
    @section('script')
        ...
        <script>
            $(document).ready(function() {
                // Mengambil status checkbox dari localStorage jika ada
                const checkbox = $('#switchSizeLargeChecked');
                ...
                checkbox.change(function() {
                    if ($(this).is(':checked')) {
                        // Checkbox dicentang, simpan status dan kirim form
                        localStorage.setItem('checkboxStatus', 'true');
                        $('#toggleForm').submit();
                    } else {
                        // Checkbox tidak dicentang, simpan status dan kirim form
