                        ...
                        <table class="table align-middle table-nowrap" id="customerTable">
                            ...
                            <tbody class="list form-check-all">
                                <tr align="center">
                                    ...
                                    <td >
                                        <img src="assets/images/galaxy/img-1.png" alt="My Image" style="max-width: 150px; max-height:150px;">
                                    </td>
                                    <td>Lorem ipsum dolor sit amet consectetur.....</td>
                                    <td class="status">
                                        <h5><span class="badge bg-success-subtle text-success text-uppercase">Di Terima</span>
                                        </h5>
                                    </td>
                                    <td>
                                        <div class="view">
                                ...
                                <tr align="center">
                                    ...
                                    <td>Lorem ipsum dolor sit amet consectetur.....</td>
                                    <td class="status">
                                        <h5><span class="badge bg-danger-subtle text-danger text-uppercase">Di Tolak</span></h5>
                                    </td>
                                    <td>
                                        <div class="view">
                                            <button class="btn btn-soft-primary  edit-item-btn" data-bs-toggle="modal" data-bs-target="#showModal">
