                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button type="button"
                                                ...
                                                <i class="ri-apps-2-line align-bottom me-2 text-secondary"></i> Tempatkan
                                                Mentor
                                            </button>
                                        </td>
                                    </tr>
            ...
            <div class="modal-content">
                ...
                <form action="" id="form-placement-edit" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="example-date-input" class="form-label">Pilih Mentor</label>
                            <select class="form-select" id="edit-mentor" name="mentor_id" aria-label="Default select example">
                                @foreach ($mentors as $mentor)
                                    <option value="{{ $mentor->mentor->id }}">{{ $mentor->mentor->name }}</option>
                                @endforeach
                            </select>
