            ...
            <div class="col">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <span class="badge bg-success-subtle fw-light text-warning px-3 py-2">
                            Selesai
                        </span>
                        @endif
                        ...
                        <div class="d-flex justify-content-center mt-3">
                            <a href="{{ route('administrator.student-progress.project.detail',$project->id) }}" class="btn btn-primary w-100">Detail Progress</a>
                        </div>
                    </div>
                </div>
            </div>
