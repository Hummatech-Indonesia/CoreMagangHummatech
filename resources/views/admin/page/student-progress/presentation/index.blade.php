...
@section('content')
    <div class="card">
                            ...
                            <a data-bs-toggle="tab" href="#todaypresentation" role="tab"
                               class="nav-link d-flex align-items-center justify-content-center active px-3 px-md-3 me-2 text-body-color">
                                <svg class="icon-tab" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16"
                                    ...
                                    <path
                                        d="M13 18V20H17V22H7V20H11V18H3C2.44772 18 2 17.5523 2 17V4C2 3.44772 2.44772 3 3 3H21C21.5523 3 22 3.44772 22 4V17C22 17.5523 21.5523 18 21 18H13ZM4 5V16H20V5H4ZM10 7.5L15 10.5L10 13.5V7.5Z"></path>
                                </svg>
                    ...
                    <li class="nav-item ms-auto d-flex align-items-center">
                        ...
                        <span class="input-group-text custom-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"
                                ...
                                <path fill="none" d="M0 0h24v24H0z"></path>
                                <path
                                    d="M9 1V3H15V1H17V3H21C21.5523 3 22 3.44772 22 4V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V4C2 3 2 3 3 3H7V1H9ZM20 11H4V19H20V11ZM8 13V15H6V13H8ZM13 13V15H11V13H13ZM18 13V15H16V13H18ZM7 5H4V9H20V5H17V7H15V5H9V7H7V5Z"></path>
                            </svg>
                        </span>
                        ...
                        <form style="max-width: 180px;">
                            <div class="search-box ms-auto d-flex my-2">
                                <input class="form-control custom-input" id="searchStudentList" name="studentName"
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane" id="presentationhistory" role="tabpanel">
                <div class="card-body">
                    <div class="table-responsive">
            ...
            <div class="tab-pane" id="notyetpresentation" role="tabpanel">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="dataTableStudentProgress3"
                               class="table stripe row-border order-column nowrap"
                               style="width:100%">
                            <thead>
                            <tr>
                                <th>No</th>
