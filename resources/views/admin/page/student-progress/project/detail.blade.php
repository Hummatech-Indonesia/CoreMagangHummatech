...
@section('content')
    <div class="d-flex align-items-center justify-content-between mb-4">
        <!-- Tombol Kembali -->
        <a href="javascript:void(1);" class="btn btn-back py-3 px-3 me-3 d-flex align-items-center custom-card shadow-sm"
            style="background-color: rgba(234, 233, 255, 1); border-radius: 8px;" onclick="window.history.back();">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                            ...
                            <div>
                                <div class="status-container">
                                    ...
                                    <a href="/administrator/student-progress/project/detail/{{ $project->id }}/revision"
                                        class=" badge bg-info-subtle px-3 text-info py-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20"
                                            height="20" fill="rgba(93,135,255,1)">
                                            <path fill="none" d="M0 0h24v24H0z"></path>
                                            <path
                                ...
                                <div class="d-flex align-items-center gap-2 pt-1">
                                    @if ($project->status == \App\Enum\ProjectAcceptStatus::ACCEPT)
                                        <span class="rounded-pill badge bg-success-subtle px-3 text-success py-2">
                                            Disetujui
                                        </span>
                                    @elseif($project->status == \App\Enum\ProjectAcceptStatus::WAITING)
                                        <span class="rounded-pill badge bg-warning-subtle px-3 text-warning py-2">
                                            Menunggu
                                        </span>
                                    @elseif($project->status == \App\Enum\ProjectAcceptStatus::REJECTED)
                                        <span class="rounded-pill badge bg-danger-subtle px-3 text-danger py-2">
                                            Ditolak
                                        </span>
                                    @endif
                                        ...
                                        @if ($project->status == \App\Enum\ProjectAcceptStatus::ACCEPT)
                                            @switch($project->status_project)
                                                @case(\App\Enum\TaskStatusEnum::INPROGRESS->value)
                                                    <span
                                                        class="rounded-pill badge bg-primary-subtle px-3 text-primary fw-bolder p-2">Sedang
                                                        dikerjakan
                                                    </span>
                                                @break
                                                ...
                                                @default
                                                    <span class="rounded-pill badge bg-primary-subtle px-3 text-primary py-2">
                                                        Sedang dikerjakan
                                                    </span>
                                                @break
                                            @endswitch
                        ...
                        <div class="mb-3">
                            ...
                            <div>
                                <span class="rounded-pill badge bg-info-subtle px-3 text-info py-2">
                                    {{ ucwords($project->type_project->value) }}
                                </span>
                            </div>
                        </div>

                        <div class="mb-4">
                            <h6 class="fw-semibold">Deskripsi Project</h6>
