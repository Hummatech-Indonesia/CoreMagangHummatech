                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="gap-2">
                                ...
                                <button class="bg-transparent border-0 btn-edit" data-id="{{ $division->id }}"
    ...
    <div class="modal fade" id="add" tabindex="-1" aria-labelledby="varyingcontentModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('administrator.division.store') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="mb-1">
                            <label for="name" class="col-form-label">Divisi</label>
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                name="name" placeholder="Tambah Divisi">
                            @error('name')
                                <p class="text-danger">
                                    {{ $message }}
                                </p>
